    ...
    return (
        <main>
            ...
            <section className="container mx-auto px-4 md:px-8 py-10 text-center">
                ...
                <div className='grid grid-cols-2 max-w-4xl mx-auto pt-8'>
                    ...
                    <div className='space-y-4 max-w-[400px] mx-auto mt-8'>
            ...
            <section className='bg-[url("/real-estate.jpg")] bg-left-bottom py-28 relative z-10'>
                <div className="h-full w-full bg-black/50 absolute top-0 left-0 -z-10"/>
                <div className="container mx-auto px-4 md:px-8">
                    <div className="w-2/5 leading-loose ml-auto text-white text-xl font-medium md:mr-10">
                ...
                <div className="container mx-auto px-4 md:px-8 py-16">
                    ...
                    <ul className='flex justify-around'>
                        {partners.map((item, index) => {
                            return(
                                <li key={index} className=' h-28 w-28 rounded-md relative overflow-hidden'>
                                    <Image
                                        src={item}
                                        fill
                                        alt='Partner Logo'
            ...
            <section className='bg-[#F7f7f7] py-14'>
                <div className="container mx-auto px-4 md:px-8">
                    ...
                    <ul className='flex flex-nowrap overflow-x-scroll py-8 no-scrollbar'>
                        {testimonials.map((item, index) =>{
                            return(
                                <li className='w-1/3 pr-8'>
